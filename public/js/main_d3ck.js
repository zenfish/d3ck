            ...
            $.getJSON('/d3ck/' + val, function(d3ckinfo) {
                ...
                if (my_d3ck.did != val) {
                   ...
                   var template = 
                    ...
                    // load up trust info
                    load_capabilities(d3ckinfo, '#d3ck_cap_table tbody')
                    ...
                    load_capabilities(my_d3ck, '#d3ck_cap_table tbody')
